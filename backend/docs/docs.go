...
const docTemplate = `{
    ...
    "paths": {
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request data or wrong password",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.ReceiptListResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.ReceiptResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/telegram/customers/{customer_id}/orders": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateTelegramOrderRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/telegram/orders/{order_id}/cancel": {
            "patch": {
        ...
        "/telegram/orders/{order_id}/confirm": {
            "patch": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateTransactionPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/transactions/days": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Number of days (e.g., 7, 30, 90)",
                        "name": "days",
                        "in": "query",
                        "required": true
                    }
        ...
        "/transactions/source": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Transaction source (receipt/whatsapp/manual)",
                        "name": "source",
                        "in": "query",
                        "required": true
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.TransactionStats"
                                        }
                                    }
                                }
                            ]
        ...
        "/users/me": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Session valid with user data",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
    ...
    "definitions": {
        ...
        "models.CreateTelegramOrderRequest": {
            "type": "object",
            "required": [
                "customer_id",
                "items"
        ...
        "models.CreateTransactionPayload": {
            "type": "object",
            "required": [
                "amount",
                "source",
    ...
    "tags": [
        ...
        {
            "description": "Operations related to receipt",
            "name": "Receipts",
            "externalDocs": {
                "url": "https://example.com/docs/receipts"
            }
        },
        {
            ...
            "name": "Transactions",
            "externalDocs": {
                "url": "https://example.com/docs/transactions"
            }
        },
        {
            "description": "Operations related to pruduct management",
            "name": "Product",
            "externalDocs": {
        ...
        {
            "description": "Operations related to customer management via Telegram bot",
            "name": "Customers",
            "externalDocs": {
                "url": "https://example.com/docs/customers"
            }
        },
        {
            "description": "Telegram bot endpoints for customer operations",
            "name": "Telegram",
            "externalDocs": {
                "url": "https://example.com/docs/telegram"
            }
        }
    ]
}`
